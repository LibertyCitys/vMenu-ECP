    ...
    public static class ValidWeapons
    {
        ...
        public static readonly Dictionary<string, string> weaponNames = new Dictionary<string, string>()
        {
            ...
            { "WEAPON_STEALTHCARBINE", GetLabelText("WT_RIFLE_STLTH") },
               { "weapon_glock17", GetLabelText("weapon_glock17") },
   { "weapon_model659", GetLabelText("weapon_model659") },
   { "weapon_statgear", GetLabelText("weapon_statgear") },
   { "weapon_fireaxe", GetLabelText("weapon_fireaxe") },
   { "weapon_fn509", GetLabelText("weapon_fn509") },
   { "weapon_shovel", GetLabelText("weapon_shovel") },
   { "weapon_pickaxe", GetLabelText("weapon_pickaxe") },
   { "weapon_pipe", GetLabelText("weapon_pipe") },
   { "weapon_katana", GetLabelText("weapon_katana") },
   { "weapon_p320", GetLabelText("weapon_p320") },
   { "weapon_sledgehammer", GetLabelText("weapon_sledgehammer") },
   { "weapon_woodenbat", GetLabelText("weapon_woodenbat") },
   { "weapon_p99", GetLabelText("weapon_p99") },
   { "weapon_m9a3", GetLabelText("weapon_m9a3") },
   { "weapon_p226r", GetLabelText("weapon_p226r") },
   { "weapon_tx22", GetLabelText("weapon_tx22") },
   { "weapon_mp", GetLabelText("weapon_mp") },
   { "weapon_p320c", GetLabelText("weapon_p320c") },
   { "weapon_lbd", GetLabelText("weapon_lbd") },
   { "weapon_ar15ris2", GetLabelText("ar15ris2") },
   { "weapon_ar15ris3", GetLabelText("ar15ris3") },
   { "weapon_medbag", GetLabelText("weapon_medbag") },
   { "weapon_colbaton", GetLabelText("weapon_colbaton") },
   { "weapon_pocketlight", GetLabelText("weapon_pocketlight") },
   { "weapon_beanbag", GetLabelText("weapon_beanbag") },
   { "weapon_benelli", GetLabelText("weapon_benelli") },
   { "weapon_supernova", GetLabelText("weapon_supernova") },
   { "weapon_beanbag", GetLabelText("weapon_beanbag") },
